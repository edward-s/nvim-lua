...
function M.on_attach(client, buffer)
	...
	self:map("gb", vim.lsp.buf.type_definition, { desc = "Goto Type Definition" })
	self:map("gB", "Lspsaga peek_type_definition", { desc = "Peek Type Definition" })
	self:map("gr", "Lspsaga rename", { desc = "Rename" })
	self:map("]e", M.diagnostic_goto(true, "WARNING"), { desc = "Next Warning" })
	self:map("[e", M.diagnostic_goto(false, "WARNING"), { desc = "Prev Warning" })
